...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
  ...
  <section class="shipping-calculator-fields">
    ...
    <?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', false ) ) : ?>
      ...
      <p class="form-row form-row-wide">
        <input type="text" class="input-text" value="<?php echo esc_attr( $woocommerce->customer->get_shipping_city() ); ?>" placeholder="<?php _e( 'City', '__x__' ); ?>" name="calc_shipping_city" id="calc_shipping_city" />
      </p>
    ...
    <?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
      ...
      <p class="form-row form-row-wide">
        <input type="text" class="input-text" value="<?php echo esc_attr( $woocommerce->customer->get_shipping_postcode() ); ?>" placeholder="<?php _e( 'Postcode / Zip', '__x__' ); ?>" name="calc_shipping_postcode" id="calc_shipping_postcode" />
      </p>
