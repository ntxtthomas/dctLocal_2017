...
<?php else : ?>
  ...
  <form action="<?php echo esc_url( add_query_arg( 'address', $load_address, get_permalink( woocommerce_get_page_id('edit_address') ) ) ); ?>" class="form-edit-address" method="post">

    <h3><?php if ($load_address=='billing') _e( 'Billing Address', '__x__' ); else _e( 'Shipping Address', '__x__' ); ?></h3>
