...
if ( class_exists( 'RevSlider' ) ) :
  ...
  foreach ( $arrSliders as $revSlider ) :
    ...
    if ( ${"slider_enable_" . $i} == 1 && is_page( ${"slider_page_" . $i} ) && ${"slider_location_" . $i} == 'below' ) : ?>

      <div class="x-slider-revolution-container below <?php if ( ${"slider_video_" . $i} != '' ) { echo 'bg-video'; } ?>">
