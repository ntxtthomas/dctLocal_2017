...
//   05. Deregister Contact Form 7 Styles
// =============================================================================
...
if ( ! function_exists( 'x_enqueue_site_styles' ) ) :
  function x_enqueue_site_styles() {
    ...
    if ( ! is_admin() ) {
      ...
      //
      // 1. Main stylesheet.
      // 2. Stack specific stylesheets.
      // 3. WooCommerce styles.
      // 4. Gravity Forms styles.
      // 5. Font stylesheets.
      //
      ...
      wp_register_style( 'x-woocommerce-integrity-light', $get_template_directory_uri . '/framework/css/site/woocommerce/integrity-light.css', NULL, NULL, 'all' ); // 3
      wp_register_style( 'x-woocommerce-integrity-dark',  $get_template_directory_uri . '/framework/css/site/woocommerce/integrity-dark.css',  NULL, NULL, 'all' ); // 3
      wp_register_style( 'x-woocommerce-renew',           $get_template_directory_uri . '/framework/css/site/woocommerce/renew.css',           NULL, NULL, 'all' ); // 3
      wp_register_style( 'x-woocommerce-icon',            $get_template_directory_uri . '/framework/css/site/woocommerce/icon.css',            NULL, NULL, 'all' ); // 3

      wp_register_style( 'x-gravity-forms-integrity-light', $get_template_directory_uri . '/framework/css/site/gravity_forms/integrity-light.css', NULL, NULL, 'all' ); // 4
      wp_register_style( 'x-gravity-forms-integrity-dark',  $get_template_directory_uri . '/framework/css/site/gravity_forms/integrity-dark.css',  NULL, NULL, 'all' ); // 4
      wp_register_style( 'x-gravity-forms-renew',           $get_template_directory_uri . '/framework/css/site/gravity_forms/renew.css',           NULL, NULL, 'all' ); // 4
      wp_register_style( 'x-gravity-forms-icon',            $get_template_directory_uri . '/framework/css/site/gravity_forms/icon.css',            NULL, NULL, 'all' ); // 4

      wp_register_style( 'x-font-custom',   $get_custom_font_family,   NULL, NULL, 'all' ); // 5
      wp_register_style( 'x-font-standard', $get_standard_font_family, NULL, NULL, 'all' ); // 5
...
if ( ! function_exists( 'x_enqueue_customizer_app_styles' ) ) :
  function x_enqueue_customizer_app_styles() {

    wp_register_style( 'x-customizer-app', get_template_directory_uri() . '/framework/css/admin/customizer-app.css', NULL, NULL, 'all' );
    wp_enqueue_style( 'x-customizer-app' );

  }
  add_action( 'customize_controls_print_styles', 'x_enqueue_customizer_app_styles' );
endif;
